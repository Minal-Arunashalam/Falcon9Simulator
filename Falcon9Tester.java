...
public class Falcon9Tester{
	...
	public static void main(String[] args) {
		...
		Falcon9 testfalcon = new Falcon9(450, 0);
		
		testfalcon.setDeltaTime(0.5);
		...
		while (testfalcon.getTime() <= testfalcon.getBurnTime()) {
			
			System.out.println(testfalcon.getTime()+", "+testfalcon.getMass()+", "+testfalcon.getFnet()+", "+testfalcon.getAcceleration()+", "+testfalcon.getVelocity()+", "+testfalcon.getAltitude());
